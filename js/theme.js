...
----------------------------------------------------- */
  ...
  $(".primary-menu ul.navbar-nav li.dropdown").on("mouseover", function () {
    if ($(window).width() > 991) {
      ...
      $(".primary-menu ul.navbar-nav > li.dropdown > .dropdown-menu").each(
        function () {
          ...
          if ($("html").attr("dir") == "rtl") {
            ...
            var i =
              rd +
              $(this).outerWidth() -
              (menu.left + $("#header .primary-menu > div").outerWidth());
          } else {
            var i =
              dropdown.left +
              $(this).outerWidth() -
    ...
    subscribeForm.each(function () {
      ...
      el.find("form").validate({
        submitHandler: function (form) {
          elResult.hide();
          var loadingText =
            '<i role="status" aria-hidden="true" class="spinner-border spinner-border-sm"></i>';
          ...
          .then(function (token) {
            ...
            $.ajax({
              ...
              beforeSend: function () {
                ...
                var loadingText =
                  '<span role="status" aria-hidden="true" class="spinner-border spinner-border-sm align-self-center me-2"></span>Sending.....'; // change submit button text
